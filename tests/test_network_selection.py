...
#    @PyCy3.skip
    ...
    def test_clear_selection(self):
        ...
        PyCy3.select_nodes(COMMON_NODES, by_col='COMMON')
        selected_nodes = PyCy3.get_selected_nodes()
        PyCy3.select_edges_connecting_selected_nodes()
        selected_edges = PyCy3.get_selected_edges()
        ...
        self.assertEqual(PyCy3.get_selected_nodes(), None)
        self.assertEqual(PyCy3.get_selected_edges(), None)
        ...
        PyCy3.select_edges_connecting_selected_nodes()
        selected_edges = PyCy3.get_selected_edges()
        PyCy3.clear_selection('nodes')
        self.assertSetEqual(set(selected_nodes), set(SELECTED_NODES))
        self.assertSetEqual(set(selected_edges), set(SELECTED_EDGES))
        self.assertEqual(PyCy3.get_selected_nodes(), None)
        self.assertSetEqual(set(PyCy3.get_selected_edges()), set(selected_edges))
        PyCy3.clear_selection()
        ...
        PyCy3.select_edges_connecting_selected_nodes()
        selected_edges = PyCy3.get_selected_edges()
        PyCy3.clear_selection('edges')
        self.assertSetEqual(set(selected_nodes), set(SELECTED_NODES))
        self.assertSetEqual(set(selected_edges), set(SELECTED_EDGES))
        self.assertSetEqual(set(PyCy3.get_selected_nodes()), set(selected_nodes))
        self.assertEqual(PyCy3.get_selected_edges(), None)
...
#    @PyCy3.skip
    ...
    def test_select_first_neigbors(self):
        # Initialization
        load_test_session()
        df_all_nodes = PyCy3.get_table_columns(columns='COMMON')
        ...
        PyCy3.clear_selection()
        PyCy3.select_nodes(['RAP1'], by_col='COMMON')
        self.assertDictEqual(PyCy3.select_first_neighbors(direction='bogus'), {})
...
#    @PyCy3.skip
    ...
    def test_select_nodes(self):
        ...
        nodes_selected = PyCy3.select_nodes(['PDC1'], by_col='COMMON')['nodes']
        self.assertSetEqual(set(nodes_selected), set([suid_PDC1]))
        self.assertSetEqual(set(PyCy3.get_selected_nodes(node_suids=True)), set([suid_RAP1, suid_GCR1, suid_PDC1]))

        # Verify that selecting only PEP12 is reported selected and that other nodes don't remain selected
        nodes_selected = PyCy3.select_nodes(['PEP12'], by_col='COMMON', preserve_current_selection=False)['nodes']
        self.assertSetEqual(set(nodes_selected), set([suid_PEP12]))
        self.assertSetEqual(set(PyCy3.get_selected_nodes(node_suids=True)), set([suid_PEP12]))

        # verify that all nodes are reported selected
        PyCy3.clear_selection()
        nodes_selected = PyCy3.select_nodes(all_selected)['nodes']
        self.assertSetEqual(set(nodes_selected), all_suids)
        self.assertSetEqual(set(PyCy3.get_selected_nodes(node_suids=True)), all_suids)

        # verify that bad nodes don't show up in the selected list
        PyCy3.clear_selection()
        nodes_selected = PyCy3.select_nodes(['RAP1x', 'GCR1'], by_col='COMMON')['nodes']
...
#    @PyCy3.skip
    ...
    def test_select_all_nodes(self):
        # Initialization
        load_test_session()
        all_suids = set(PyCy3.get_table_columns().index)

        # Verify that selector reports all nodes and that Cytoscape thinks all nodes are selected
        self.assertTrue(set(PyCy3.select_all_nodes()), all_suids)
        self.assertTrue(set(PyCy3.get_selected_nodes(node_suids=True)), all_suids)
...
#    @PyCy3.skip
    ...
    def test_get_selected_node_count(self):
        ...
        node_count = PyCy3.get_selected_node_count()
...
#    @PyCy3.skip
    ...
    def test_get_selected_nodes(self):
        ...
        nodes_selected = PyCy3.select_nodes(['YNL216W', 'YPL075W'], by_col='name')['nodes']
        nodes_reported = PyCy3.get_selected_nodes(node_suids=True)
        self.assertSetEqual(set(nodes_selected), set(nodes_reported))

        # Verify that nodes reported by name are correct
        nodes_reported = PyCy3.get_selected_nodes(node_suids=False)
...
#    @PyCy3.skip
    ...
    def test_invert_node_selection(self):
        ...
        original_nodes = set(PyCy3.invert_node_selection()['nodes'])
...
#    @PyCy3.skip
    ...
    def test_delete_selected_nodes(self):
        # Initialization
        load_test_session()
        all_node_suids = set(PyCy3.get_table_columns().index)
        ...
        self.assertDictEqual(PyCy3.delete_selected_nodes(), {})

        # Verify that deleting all nodes deletes all nodes
        PyCy3.invert_node_selection()
        self.assertSetEqual(set(PyCy3.delete_selected_nodes()['nodes']), all_node_suids)
        self.assertEqual(PyCy3.get_node_count(), 0)
...
#    @PyCy3.skip
    ...
    def test_select_edges(self):
        ...
        selection = PyCy3.select_edges(single_edge_suid, preserve_current_selection=False)
        ...
        selection = PyCy3.select_edges(EDGE_LIST, by_col='name', preserve_current_selection=True)
        ...
        selected_edges = PyCy3.get_selected_edges(edge_suids=True)
...
#    @PyCy3.skip
    ...
    def test_select_all_edges(self):
        ...
        all_edge_suids = PyCy3.edge_name_to_edge_suid(PyCy3.get_all_edges())
        self.assertSetEqual(set(all_edge_suids), set(PyCy3.select_all_edges()))
...
#    @PyCy3.skip
    ...
    def test_invert_edge_selection(self):
        ...
        # Verify that all edges get selected
        self.assertSetEqual(set(all_edge_suids), set(PyCy3.invert_edge_selection()['edges']))

        # Verify that all edges get deselected
        self.assertDictEqual(PyCy3.invert_edge_selection(), {})
...
#    @PyCy3.skip
    ...
    def test_delete_selected_edges(self):
        ...
        self.assertDictEqual(PyCy3.delete_selected_edges(), {})

        # Verify that all edges get selected and are deleted
        self.assertSetEqual(set(all_edge_suids), set(PyCy3.invert_edge_selection()['edges']))
        self.assertSetEqual(set(all_edge_suids), set(PyCy3.delete_selected_edges()['edges']))
        self.assertIsNone(PyCy3.get_all_edges())
...
#    @PyCy3.skip
    ...
    def test_get_selected_edge_count(self):
        ...
        self.assertEqual(PyCy3.get_selected_edge_count(), 0)

        # Verify that all edges get selected and are counted
        self.assertSetEqual(set(all_edge_suids), set(PyCy3.invert_edge_selection()['edges']))
        self.assertEqual(PyCy3.get_selected_edge_count(), len(all_edge_suids))
...
#    @PyCy3.skip
    ...
    def test_get_selected_edges(self):
        ...
        self.assertIsNone(PyCy3.get_selected_edges())
...
#    @PyCy3.skip
    ...
    def test_select_edges_connecting_selected_nodes(self):
        ...
        selected_nodes = PyCy3.select_nodes(COMMON_NODES, by_col='COMMON')['nodes']
        selection = PyCy3.select_edges_connecting_selected_nodes()
        expected_edges = PyCy3.edge_name_to_edge_suid(EXPECTED_EDGES)  # expected edges
        self.assertSetEqual(set(selected_nodes), set(selection['nodes']))
...
#    @PyCy3.skip
    ...
    def test_delete_duplicate_edges(self):
        # Initialization
        load_test_session()
        original_edge_count = PyCy3.get_edge_count()
        EDGE_TO_DUP = ['YNL216W (pd) YLR044C']
        original_edge_suid = PyCy3.get_edge_info([EDGE_TO_DUP])[0]['SUID']

        # Verify that when no edges are duplicated, no edges get deleted
        self.assertDictEqual(PyCy3.delete_duplicate_edges(), {})
        ...
        first_copy_edge_suid = PyCy3.add_cy_edges(['YNL216W', 'YLR044C'], edge_type='pd')[0]['SUID']
...
#    @PyCy3.skip
    ...
    def test_delete_self_loops(self):
        ...
        original_edges = PyCy3.get_all_edges()
        self.assertEqual(PyCy3.delete_self_loops(), '')
        self.assertSetEqual(set(PyCy3.get_all_edges()), set(original_edges))

        # Add a few self-edges and make sure they get deleted
        self_edge_PFK27_1 = PyCy3.add_cy_edges(['YOL136C', 'YOL136C'], edge_type='pp')
        self_edge_PFK27_2 = PyCy3.add_cy_edges(['YOL136C', 'YOL136C'], edge_type='pp')
        self_edge_PDC1 = PyCy3.add_cy_edges(['YLR044C', 'YLR044C'], edge_type='pp')
        self.assertEqual(PyCy3.delete_self_loops(), '')
        self.assertSetEqual(set(PyCy3.get_all_edges()), set(original_edges))
