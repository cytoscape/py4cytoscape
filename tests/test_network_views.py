...
#    @PyCy3.skip
    ...
    def test_get_network_views(self):
        ...
        gal_filtered_view_suid = check_view_list(PyCy3.get_network_views())
        ...
        check_view_suid = check_view_list(PyCy3.get_network_views(network=yeast_suid))
        ...
        self.assertEqual(check_view_list(PyCy3.get_network_views('galFiltered.sif')), gal_filtered_view_suid)
...
#    @PyCy3.skip
    ...
    def test_get_network_view_suid(self):
        ...
        gal_filtered_view_suid = check_view(PyCy3.get_network_view_suid())

        # Verify that the view suid for a different network looks right ... identify network by suid
        yeast_suid, yeast_view_suid = load_test_network('data/yeastHighQuality.sif', make_current=False)
        check_view_suid = check_view(PyCy3.get_network_view_suid(network=yeast_suid))
        self.assertEqual(yeast_view_suid, check_view_suid)
        self.assertNotEqual(gal_filtered_view_suid, yeast_view_suid)

        # Verify that the view list for the original network is unchanged ... identify network by string
        self.assertEqual(check_view(PyCy3.get_network_view_suid('galFiltered.sif')), gal_filtered_view_suid)

        # Verify that the view list for the original network is unchanged ... identify view by view suid
        self.assertEqual(check_view(PyCy3.get_network_view_suid(gal_filtered_view_suid)), gal_filtered_view_suid)
...
#    @PyCy3.skip
    ...
    def test_fit_content(self):
        ...
        fit_res = PyCy3.fit_content(selected_only=False)
        ...
        PyCy3.select_nodes(nodes=['RAP1'], by_col='COMMON')
        PyCy3.select_first_neighbors()
        time.sleep(5)
        fit_res = PyCy3.fit_content(selected_only=True)
        self.assertIsInstance(fit_res, dict)
        self.assertDictEqual(fit_res, {})
        ...
        PyCy3.select_nodes(['SIK1', 'PGK1'], by_col='COMMON', network=yeast_suid)
        fit_res = PyCy3.fit_content(selected_only=True, network=yeast_view_suid)
        self.assertIsInstance(fit_res, dict)
        self.assertDictEqual(fit_res, {})
...
#    @PyCy3.skip
    ...
    def test_set_current_view(self):
        # Initialization
        load_test_session()
        gal_filtered_view = PyCy3.get_network_view_suid()
        yeast_suid, yeast_view_suid = load_test_network('data/yeastHighQuality.sif', make_current=False)

        # Set the view for galFiltered by passing in network SUID
        res = PyCy3.set_current_view(network=PyCy3.get_network_suid('galFiltered.sif'))
        self.assertIsInstance(res, dict)
        self.assertDictEqual(res, {})

        # Set the view for yeastHighQuality by passing in view
        res = PyCy3.set_current_view(network=yeast_view_suid)
        self.assertIsInstance(res, dict)
        self.assertDictEqual(res, {})

        # Verify that both views seem to be set
        self.assertEqual(PyCy3.get_network_view_suid(network='galFiltered.sif'), gal_filtered_view)
        self.assertEqual(PyCy3.get_network_view_suid(network=yeast_suid), yeast_view_suid)
...
#    @PyCy3.skip
    ...
    def test_export_image(self):
        ...
        load_test_session()
        gal_filtered_view = PyCy3.get_network_view_suid()
        gal_filtered_suid = PyCy3.get_network_suid()
...
#    @PyCy3.skip
    ...
    def test_export_image(self):
        ...
        res = PyCy3.toggle_graphics_details()
        self.assertIsInstance(res, dict)
