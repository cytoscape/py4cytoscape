...
def find_node_set(node_to_find, node_set_size, node_order, node_bag):
    # Find list of nodes containing a particular node and a number of similar nodes
    node_to_find = str(node_to_find)
    ...
    return list(cur_node.suid.union(parent_nodes))
