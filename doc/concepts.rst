...
.. code:: python
    ...
    set_node_fill_opacity_mapping(**gen_node_opacity_map('Degree', scheme_number_series(start_value=100, step=20), style_name='galFiltered Style'))

    set_node_fill_opacity_mapping(**gen_node_opacity_map('Degree', scheme_number_random(min_value=10, max_value=120), style_name='galFiltered Style'))
